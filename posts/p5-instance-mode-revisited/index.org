...
This is a re-do of another {{% lancelot title="post" %}}testing-with-rst{{% /lancelot %}} I did where I tried to remember how to get P5 working again. This is a class-based version that doesn't set everything up in the constructor the way I did it previously. This adds more lines, but it seems better organized to me.

* The Code

#+include: ../files/posts/p5-instance-mode-revisited/class_based_instance_mode.js src js
