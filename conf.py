...
BLOG_TITLE = "p5.js (processing) Explorations"  # (translatable)
...
BLOG_EMAIL = "necromuralist@gmail.com/p5_explorations"
BLOG_DESCRIPTION = "Notes made while trying to learn p5.js."  # (translatable)
